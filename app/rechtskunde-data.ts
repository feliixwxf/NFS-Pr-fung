...
export const rechtskundeFlashcards: LegalFlashcard[] = [
  ...
  { id: "recht-card-07", area: "ThürPsychKG", question: "Warum ist § 14 ThürPsychKG keine pauschale präklinische Fixierungsbefugnis für den Rettungsdienst?", answer: "§ 14 regelt besondere Sicherungsmaßnahmen bei bereits untergebrachten Patienten in der Einrichtung. Präklinisch braucht jeder körperliche Zwang eine eigene tragfähige Rechtsgrundlage, muss ultima ratio, verhältnismäßig und möglichst kurz sein sowie eng überwacht und dokumentiert werden; Polizei und Notarzt sind früh einzubeziehen." },
  { id: "recht-card-08", area: "Fixierung", question: "Welche Kerngrenze gilt im ThürPsychKG für eine nicht nur kurzfristige Fixierung?", answer: "Grundsätzlich ist eine vorherige richterliche Entscheidung nötig. Als kurzfristig gilt die Fixierung in der Regel, wenn absehbar unter 30 Minuten. Bei Gefahr im Verzug gelten enge Anordnungs-, Nachhol-, Überwachungs- und Dokumentationspflichten." },
...
export const rechtskundeQuestions: LegalQuestion[] = [
  ...
  { id: "recht-q-13", prompt: "Ein akut psychotischer Patient gefährdet sich und andere. Welche Aussagen zur präklinischen Zwangsanwendung sind tragfähig?", options: [
    { text: "Zunächst sind Deeskalation, sichere Umgebung und weniger eingreifende Mittel zu prüfen.", correct: true },
    { text: "§ 14 ThürPsychKG ist keine pauschale unmittelbare Fixierungsbefugnis für den Rettungsdienst am Einsatzort.", correct: true },
    { text: "Jeder körperliche Zwang braucht im konkreten Fall eine Rechtsgrundlage und muss verhältnismäßig sein.", correct: true },
    { text: "Eine psychiatrische Arbeitsdiagnose genügt unabhängig von einer Gefahr für eine Fixierung." },
  ], source: "Zwang ist ultima ratio. Präklinisch sind konkrete Gefahrenlage, tragfähige Rechtsgrundlage, Verhältnismäßigkeit, Überwachung, Dokumentation und frühzeitige Unterstützung entscheidend.", difficulty: 3, mode: "multiple" },
