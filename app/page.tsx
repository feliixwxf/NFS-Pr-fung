...
const apoplexSingleChoiceQuestions: SingleChoiceQuestion[] = [
  ...
  { id: "apoplex-tf-06", prompt: "Welche unmittelbare Gefahrenkette nennt das Skript beim hämorrhagischen Schlaganfall?", options: [{ text: "Blutung → Verdrängung von Hirngewebe → Hirndruckanstieg → Einklemmungsgefahr", correct: true }, { text: "Blutung → Gefäßverschluss → Glukosemangel → Infarktgebiet" }, { text: "Blutung → verminderte Perfusion → Natriumverlust → Einklemmungsgefahr" }, { text: "Blutung → freie Sauerstoffradikale → Blutdruckabfall → Infarktgebiet" }], source: "Die Blutung verdrängt Hirngewebe; der Hirndruck steigt bis zur Einklemmungsgefahr.", difficulty: 1 },
  { id: "apoplex-tf-07", prompt: "Die Symptome haben sich nach wenigen Minuten vollständig zurückgebildet. Welche Konsequenz folgt aus dem Skript?", options: [{ text: "TIA bleibt ein Notfall; eine Stroke Unit ist notwendig", correct: true }, { text: "TIA ist ausgeschlossen; weitere Maßnahmen entfallen" }, { text: "Nur bei positivem BEFAST ist eine Stroke Unit notwendig" }, { text: "Die Rückbildung spricht gegen einen neurologischen Notfall" }], source: "Bei der TIA bilden sich die Symptome meist innerhalb von Minuten komplett zurück – sie bleibt aber ein Notfall; Stroke Unit notwendig.", difficulty: 2 },
  { id: "apoplex-tf-08", prompt: "Welcher Befund kann die Arbeitsdiagnose laut Skript zusätzlich stützen?", options: [{ text: "Bewusstseinsstörung", correct: true }, { text: "Vollständig unauffälliger BEFAST-Test" }, { text: "Ausschließlich hämodynamische Instabilität" }, { text: "Fehlende neurologische Auffälligkeiten" }], source: "Eine Bewusstseinsstörung ist beim Schlaganfall möglich.", difficulty: 2 },
  { id: "apoplex-tf-09", prompt: "Ab wann stützt BEFAST im Skript die Arbeitsdiagnose?", options: [{ text: "Ab mindestens einem positiven Befund", correct: true }, { text: "Erst ab zwei positiven Befunden" }, { text: "Nur bei gleichzeitig gestörtem Bewusstsein" }, { text: "Nur bei zusätzlicher Hypoglykämie" }], source: "BEFAST: mindestens ein Befund positiv.", difficulty: 2 },
  { id: "apoplex-tf-10", prompt: "Welches vorbereitete Maßnahmenpaket entspricht vollständig dem Skript?", options: [{ text: "BZ-Kontrolle und venöser Zugang mindestens 18 G", correct: true }, { text: "BZ-Kontrolle und venöser Zugang höchstens 18 G" }, { text: "BEFAST und venöser Zugang erst in der Stroke Unit" }, { text: "30°-Lagerung ohne BZ-Kontrolle und ohne Zugang" }], source: "Genannt werden BZ-Kontrolle und ein Zugang mindestens Größe 18 G.", difficulty: 2 },
  { id: "apoplex-tf-11", prompt: "Welche Kombination besteht ausschließlich aus im Skript genannten Differenzialdiagnosen?", options: [{ text: "Hypoglykämie, postiktaler Zustand, Migräne mit Aura", correct: true }, { text: "Hypoglykämie, TIA, Hirnödem" }, { text: "SAB, Cushing-Triade, Migräne mit Aura" }, { text: "Hemiparese, postiktaler Zustand, Hypoglykämie" }], source: "Genannt werden unter anderem Hypoglykämie, epileptischer Anfall/postiktaler Zustand und Migräne mit Aura.", difficulty: 2 },
  { id: "apoplex-tf-12", prompt: "Welche Lagerung nennt das Skript für die weitere Versorgung?", options: [{ text: "30° Oberkörperhochlagerung", correct: true }, { text: "30° Beinhochlagerung" }, { text: "Flache Rückenlage ohne Oberkörperhochlagerung" }, { text: "Ausschließlich stabile Seitenlage" }], source: "Das Skript nennt eine 30°-Oberkörperhochlagerung.", difficulty: 2 },
...
function SingleChoiceQuiz({ onProgressChange, standalone = false }: { onProgressChange: (progress: QuestionProgress) => void; standalone?: boolean }) {
  ...
  if (!questions.length) return <div className={`ai-question-panel quiz-launch ${standalone ? "standalone" : ""}`}><div><span className="eyebrow">{standalone ? "MC-Training" : "Nach dem Lesen"}</span><h2>Anspruchsvolle Single-Choice-Fragen</h2><p>Jede Frage hat vier plausible Antworten. Inhalte und Erklärungen stammen ausschließlich aus deinem Schlaganfall-Skript; Fragen und Antwortmöglichkeiten werden bei jedem Neustart neu gemischt.</p></div><button className="primary-button" onClick={start}>{standalone ? "Training starten" : "Prüfungsfragen starten"}</button></div>;
...
function QuizTraining({ onProgressChange }: { onProgressChange: (progress: QuestionProgress) => void }) {
  return <section className="quiz-page mc-training-page"><div className="section-heading"><div><span className="eyebrow">MC-Training · Schlaganfall</span><h1>Single-Choice aus deinem Skript</h1><p>Vier plausible Antwortmöglichkeiten fordern genaues Lesen und Verknüpfen. Die Schwierigkeit steigt bis zum Staatsexamensniveau; alle Ergebnisse fließen in dieselbe Statistik ein.</p></div><div className="source-badge"><b>18</b><span>Fragen</span></div></div><SingleChoiceQuiz standalone onProgressChange={onProgressChange} /><div className="mc-training-rule"><span>3×</span><p><b>Dreistufiger Lernstand</b>Richtig beantwortete Fragen steigen auf 33 %, 67 % und 100 %. Eine falsche Antwort setzt nur die betreffende Frage auf 0 % zurück.</p></div></section>;
}
